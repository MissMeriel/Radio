...
public class Simulation {
	...
	private static final String NEWLIST = "src/HotListSim.txt";
	private static final String OLDLIST = "src/OldListSim.txt";
	private static final String SONGLIST = "src/SongList.txt";
